...
public class RecipeService {
    private static final String SCHEMA_FILE = "recipe_schema.sql"; // Make sure this file is in your resources folder
    ...
    private List<String> extractLinesContent(String content) {
        ...
        while (!content.isEmpty()) {
            ...
            if (semicolon == -1) {
                ...
                content = content.substring(semicolon + 1); // fixed here
            }
        }
        return lines;
    }
    ...
    private String replaceWhitespaceSequenceWithSingleSpace(String content) {
        return content.replaceAll("\\s+", " ");  // fixed here
    }
    ...
    public static void main(String[] args) {
        new RecipeService().createAndPopulatedTables();
    }
}
